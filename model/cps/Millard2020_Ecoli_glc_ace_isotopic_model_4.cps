...
<!-- generated with COPASI 4.27 (Build 217) (http://www.copasi.org) at 2020-05-05T10:53:15Z -->
  ...
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5376" name="V" value="5557.64"/>
          <Constant key="Parameter_5375" name="KM" value="0.02"/>
          <Constant key="Parameter_5374" name="Ki" value="36.6776"/>
        </ListOfConstants>
  ...
  <rdf:Description rdf:about="#Reaction_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5373" name="v_PTA_Vmax" value="9.56552e+06"/>
  ...
  <rdf:Description rdf:about="#Reaction_7">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5326" name="v_ACK_Vmax" value="336940"/>
          <Constant key="Parameter_5327" name="ACE" value="1"/>
          <Constant key="Parameter_5328" name="ATP" value="2.4"/>
    ...
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_5302" name="v_PTA_KmACP" value="0.7"/>
        </ListOfConstants>
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2020-05-05T10:52:17Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=E. coli model - Glc-Ace metabolism,Vector=Values[v_PTA_Vmax]" value="9565521.7634551357" type="ModelValue" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=E. coli model - Glc-Ace metabolism,Vector=Values[v_ACK_Vmax]" value="336940.01763224584" type="ModelValue" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=E. coli model - Glc-Ace metabolism,Vector=Values[sink_v]" value="740859.87349901034" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=E. coli model - Glc-Ace metabolism,Vector=Values[sink_Km]" value="24.759179607035055" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=E. coli model - Glc-Ace metabolism,Vector=Values[sink]" value="29662.247991208762" type="ModelValue" simulationType="assignment"/>
          ...
          <ModelParameter cn="CN=Root,Model=E. coli model - Glc-Ace metabolism,Vector=Values[v_TRP_Km]" value="33.153580532659561" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=E. coli model - Glc-Ace metabolism,Vector=Values[v_TRP_Vmax]" value="480034.55363364267" type="ModelValue" simulationType="fixed"/>
      ...
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="9.0039719975423971"/>
            <ParameterGroup name="Affected Experiments">
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="12.500002747418595"/>
            <ParameterGroup name="Affected Experiments">
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="0.07226620228687701"/>
            <ParameterGroup name="Affected Experiments">
              <Parameter name="Experiment Key" type="key" value="Experiment_1"/>
            </ParameterGroup>
            <ParameterGroup name="Affected Cross Validation Experiments">
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="14.19223119007839"/>
            <ParameterGroup name="Affected Experiments">
              <Parameter name="Experiment Key" type="key" value="Experiment_2"/>
            </ParameterGroup>
            <ParameterGroup name="Affected Cross Validation Experiments">
          ...
          <ParameterGroup name="FitItem">
            ...
            <Parameter name="StartValue" type="float" value="740859.87349901034"/>
            <ParameterGroup name="Affected Experiments">
            </ParameterGroup>
            <ParameterGroup name="Affected Cross Validation Experiments">
            </ParameterGroup>
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2020-05-05T10:52:16Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
